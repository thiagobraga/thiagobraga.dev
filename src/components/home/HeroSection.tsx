    ...
    <section ref={sectionRef} id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 overflow-hidden bg-nord0">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(180deg, rgba(46,52,64,0) 0%, rgba(46,52,64,0.03) 5%, rgba(46,52,64,0.08) 10%, rgba(46,52,64,0.13) 15%, rgba(46,52,64,0.18) 20%, rgba(46,52,64,0.24) 25%, rgba(46,52,64,0.31) 30%, rgba(46,52,64,0.38) 35%, rgba(46,52,64,0.45) 40%, rgba(46,52,64,0.52) 45%, rgba(46,52,64,0.59) 50%, rgba(46,52,64,0.65) 55%, rgba(46,52,64,0.71) 60%, rgba(46,52,64,0.76) 65%, rgba(46,52,64,0.80) 70%, rgba(46,52,64,0.83) 75%, rgba(46,52,64,0.86) 80%, rgba(46,52,64,0.89) 85%, rgba(46,52,64,0.92) 90%, rgba(46,52,64,0.96) 95%, #2e3440 100%)',
          }}
        />
      </div>
